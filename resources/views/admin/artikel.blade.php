...
.modal-footer .btn-default:hover {
	...
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.js"></script>
		...
		<div class="row tambah">
			<a href="#"><i class="fa fa-plus fa-2x" data-toggle="modal" data-target="#tambahModal">Tambah Artikel</i></a>
		</div>
    ...
    <div class="main">
        ...
        ?>
      	...
      	@foreach($artikel as $gambar)
        <div class="main-content">
                <div class="col-md-4 col-sm-3 col-xs-6">
	                    <figure>
	                        <img src="{{asset('storage/artikel/'.$gambar->gambar)}}"/>
            							<div class="detail">
                            <div class="row text-center">
                              <span>{{$gambar->judul}}</span>
                            </div>
                            
                          <div class="row">
                          	<?php // truncate string
							    $stringCut = substr($gambar->isi, 0, 100);
                            ...
                            <div class="row pull-right"> 
                              <a href="#" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil fa-2x" aria-hidden="true" onclick="editBanner({{$gambar->id}})"></i></a>
                              <a href="{{url('admin/deleteArtikel/'.$gambar->id.'/name/'.$gambar->gambar)}}"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
                            </div>
	...
	@else
		<center><h1>Artikel Kosong</h1></center>
		@endif
        ...
        <div class="modal fade" id="tambahModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <form action="{{url('admin/addArtikel')}}" method="post" enctype="multipart/form-data" id="uploadimage">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <div class="col-md-10 col-sm-10 col-xs-10">
                            <span class="modal-title">Tambah Artikel</span>
                        </div>
        ...
        <div class="modal fade" id="editModal" role="dialog">
            <div class="modal-dialog">
                ...
                <!-- Modal content-->
                <div class="modal-content">
                  <form action="{{url('admin/editArtikel')}}" method="post" enctype="multipart/form-data" id="uploadimage">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <div class="col-md-10 col-sm-10 col-xs-10">
                            <span class="modal-title">Edit Artikel</span>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-2 text-right">
                            <i class="fa fa-close" data-dismiss="modal"></i>
                        </div>
        ...
        <script type="text/javascript">
          ...
          function editBanner(id_banner) {
            ...
            $.ajax({
              type: "POST",
              dataType: "JSON",
              url: "{{url('api/getArtikelById')}}",
              data: {'id_artikel': id_banner},
              success: function(data){
                 console.log(data.keterangan)
                 var gambar = '{{asset('storage/artikel/')}}/'+data.gambar
                 console.log(gambar)
                 
                 $("#id_banner").val(data.id)
                 $("#gambar_awal").val(data.gambar)
                 $("#judulEdit").val(data.judul)
                 $("#keteranganEdit").val(data.isi)
